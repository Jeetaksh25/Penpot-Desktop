// Auto-generated fallback shared constants for the ClojureScript frontend.
// This file is used when the native render-wasm engine is not built (e.g. CI
// builds that skip Emscripten). It mirrors the export shape of
// penpot-source/frontend/src/app/render_wasm/api/shared.js so the frontend
// compiles and falls back to the SVG renderer.
//
// To refresh after a render-wasm rebuild, run:
//   node scripts/update-shared-js-stub.mjs
