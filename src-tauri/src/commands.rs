...
///
/// Lives under the OS app-data dir (e.g. `%APPDATA%\Penpot Desktop` on
/// Windows, `~/.config/Penpot Desktop` on Linux, `~/Library/Application
/// Support/Penpot Desktop` on macOS) — NOT under the install dir — so it
